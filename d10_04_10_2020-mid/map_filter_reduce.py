...
1. Dla podanej listy liczb zwróci te, które są podzielne przez 5.2. Dla par liczb zapisanych w liście [(a, b), (c, d),
...
sum_podzielnych_przez_5 = filter(lambda x: sum(x) % 5 == 0, sequence2)
print(list(sum_podzielnych_przez_5)) # [(7, 8), (9, 1)]
